...
const Footer = () => {
    return (
        <footer className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 relative bg-[black] backdrop-blur-2xl z-10 font-raleway border-white/5 mt-12 sm:mt-16 md:mt-20 lg:mt-24">
            ...
            <div className="relative z-100 font-poppins w-full max-w-7xl mx-auto py-8 sm:py-10 md:py-12">
                <div className="flex flex-col lg:flex-row items-start lg:items-start justify-between gap-8 lg:gap-12">
                    
                    <p className="text-white w-full lg:w-[40%] text-sm sm:text-base md:text-base lg:text-lg xl:text-lg font-raleway font-normal mb-4 lg:mb-0 leading-relaxed">
                    ...
                    <div className='grid grid-cols-2 sm:grid-cols-3 w-full lg:w-auto items-start justify-start gap-6 sm:gap-8 lg:gap-12 xl:gap-14'>
                        ...
                        <div>
                            <h4 className="text-white font-medium font-raleway text-base sm:text-base md:text-lg lg:text-lg xl:text-xl mb-3 sm:mb-4 border-b inline-block">Services</h4>
                            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm md:text-sm lg:text-base xl:text-base text-white/80">
                        ...
                        <div>
                            <h4 className="text-white font-medium font-raleway text-base sm:text-base md:text-lg lg:text-lg xl:text-xl mb-3 sm:mb-4 border-b inline-block">Case Studies</h4>
                            <ul className="items-start flex flex-col gap-2 sm:gap-3 text-xs sm:text-sm md:text-sm lg:text-base xl:text-base text-white/80">
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <h4 className="text-white font-medium font-raleway text-base sm:text-base md:text-lg lg:text-lg xl:text-xl mb-3 sm:mb-4 border-b inline-block">Contact Us</h4>
                            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm md:text-sm lg:text-base xl:text-base text-white/80">
                ...
                <div className="border-t border-white/10 mt-6 sm:mt-8 lg:mt-10 pt-6 sm:pt-8">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-white/80 text-xs sm:text-sm md:text-sm lg:text-base xl:text-base">
